...
export class CustomerEffects {
	...
	showActionLoadingDistpatcher = new CustomersActionToggleLoading({ isLoading: true });
	hideActionLoadingDistpatcher = new CustomersActionToggleLoading({ isLoading: false });
	...
	constructor(private actions$: Actions, private customersService: CustomerService, private store: Store<AppState>) { }
}
