...
// Distributor
import { DistributorsListComponent } from './distributor-list/distributor-list.component';
...
@NgModule({
	...
	// MatFileUploadModule,
		...
		StoreModule.forFeature('distributors', distributorsReducer),
