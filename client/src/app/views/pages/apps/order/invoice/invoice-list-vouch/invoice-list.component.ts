...
@Component({
	selector: 'kt-vinvoice-list',
	templateUrl: './invoice-list.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	})
export class VInvoicesListComponent implements OnInit, OnDestroy {
	// Table fields
	 ...
	 */
	constructor(
		public dialogRef: MatDialogRef<VInvoicesListComponent>,
	...
	ngOnInit() {
		...
		**/
		...
		const entitiesSubscription = this.dataSource.entitySubject.pipe(
			...
			// console.log(this.invoicesResult);
		});
	...
	loadInvoicesList() {
		...
		this.invoiceService.voucherid = this.data.voucher.voucherid;
		this.store.dispatch(new InvoicesPageRequested({ page: queryParams, params: params }));
		this.selection.clear();
	}
