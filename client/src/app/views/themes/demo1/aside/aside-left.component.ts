...
import { User, AuthService, currentUser } from '../../../../core/auth';
...
export class AsideLeftComponent implements OnInit, AfterViewInit {
	 ...
	 * Filter menu
	 */
	get filtermenuByroles() {
		return this.menuAsideService.menuList$.pipe(
			map((result: any) => {
				return result.filter(x => x.title !== 'User Management');
			})
		);
