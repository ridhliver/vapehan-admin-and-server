...
const query_results_model_1 = require("./query-models/query-results.model");
class HttpExtenstionsModel {
    /**
    ...
    baseFilter(_entities, _queryParams, _filtrationFields = []) {
        ...
        // end
        const queryResults = new query_results_model_1.QueryResultsModel();
