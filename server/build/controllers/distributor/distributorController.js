...
class DistributorController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const distributor = yield database_1.default.query('SELECT * FROM vh_distributor ORDER BY id DESC');
            res.json(distributor);
        });
    }
    listDIst(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const distributor = yield database_1.default.query('SELECT * FROM vh_distributor WHERE flag_stat = 1 ORDER BY id DESC');
            res.json(distributor);
        });
    }
    create(req, res) {
