...
class VoucherRoutes {
    ...
    config() {
        ...
        this.router.get('/all', voucherController_1.default.all);
        this.router.get('/getActive', voucherController_1.default.getVochActive);
        this.router.get('/:id', voucherController_1.default.detail);
        this.router.get('/det/:id', voucherController_1.default.detailVoch);
        this.router.get('/find', voucherController_1.default.find);
